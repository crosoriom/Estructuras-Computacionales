...
static keypad_state_t g_keypad_state = KEY_STATE_IDLE;
static uint8_t g_debounce_counter = 0;
#define DEBOUNCE_TIME_MS 20 // Debounce for 20 scan calls (e.g., 20ms if scanned every 1ms)
