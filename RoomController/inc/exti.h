...
/**
 * @brief Deshabilita la interrupción externa para un pin GPIO
 *
 * @param pin Número de pin al que se le inhabilitará la interrupción.
 */
void exti_disable(PINx pin);

/**
 * @brief Habilita la interrupción externa para un pin GPIO
 *
 * @param pin Número de pin al que se le habilitará la interrupción.
 */
void exti_enable(PINx pin);

/**
 * @brief Limpia el registro correspondiente para desactivar la inderrupción
 *
 * @param pin Número de pin correspondiente a la interrupción.
 */
void exti_clear(PINx pin);
#endif
